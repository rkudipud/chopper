...
**Correct Behavior:** When `--project` is used, the CLI layer must populate ALL project-related fields on `RunConfig` (the engine-behavior record inside `ChopperContext`, per [`technical_docs/ARCHITECTURE_PLAN.md`](ARCHITECTURE_PLAN.md) §1.6.1):
