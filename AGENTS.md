...
This project is indexed by GitNexus as **chopper** (4181 symbols, 7957 relationships, 84 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
