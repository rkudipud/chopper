...
This project is indexed by GitNexus as **chopper** (5647 symbols, 11345 relationships, 243 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
