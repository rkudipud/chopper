...
- [ ] GitNexus detect_changes, or local `search/changes` fallback — verify only expected files changed
...
- [ ] GitNexus detect_changes, or local `search/changes` fallback — verify affected scope
- [ ] Run tests for affected processes
```
