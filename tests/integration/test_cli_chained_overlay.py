...
#
# Spec reference: ARCHITECTURE.md §4 row 3 (FE only) — "remove F from
...
#
# Spec reference: ARCHITECTURE.md §4 row 5 (PI alone) — "union PI into
...
# narrowed keep set.
#
# Spec reference: ARCHITECTURE.md §4 row 6 — "TRIM(keep = (running_keep
...
#
# Spec reference: ARCHITECTURE.md §4 row 2/5 and prose line 452: any
...
#
# Spec reference: ARCHITECTURE.md §4 row 1/2 — glob inclusion is the
...
#
# Spec reference: ARCHITECTURE.md §4 row 2 — "VW-21 if earlier layer
