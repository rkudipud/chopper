...
set hdlin_report_vcs "json"
set hdlin_report_vcs_filename "$design_name.v2k_binding"
...
#puts [date]
iproc_msg -info "STEP DONE: read_svf"
...
puts "################################################################"
$ivar($task,read_rtl_proc_golden) $ivar($task,rtl_list_golden) $design_name
current_container r
...
check_metaflop r2g $design_name
